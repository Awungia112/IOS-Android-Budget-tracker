...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorDevice", path: "../../../node_modules/.pnpm/@capacitor+device@8.0.3_@capacitor+core@8.3.0/node_modules/@capacitor/device"),
        ...
        .package(name: "CapacitorKeyboard", path: "../../../node_modules/.pnpm/@capacitor+keyboard@8.0.5_@capacitor+core@8.3.0/node_modules/@capacitor/keyboard"),
