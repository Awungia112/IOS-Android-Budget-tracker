...
const Templates = () => {
  const { templates, categories, deleteTemplate, applyTemplate } = useBudget();
  ...
  return (
    <Layout>
      <div className="p-6">
        <h2 className="text-black dark:text-white text-sm font-semibold mb-6">
          {t("templates")}
        </h2>
          ...
          <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[#666] dark:text-gray-400 text-xs truncate">
                        {category ? translateCategoryLabel(t, category.name, category.isDefault ?? false) : t("unknownCategory")}
                      </p>
                    </div>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p
                        className={`font-bold text-xs ${
                          template.type === "income" ? "text-budget-green" : "text-budget-red"
                        }`}
                      >
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      <button
                        ...
                        aria-label={t("apply")}
                      >
                        <ArrowRight className="h-4 w-4 text-budget-blue" />
                      </button>
                      <button
            ...
            >
              ...
              >
                ...
                <div className="flex-1 flex items-center">
                  <span className="text-black dark:text-white text-sm font-semibold">{t("createTemplate")}</span>
                </div>
              </button>
            </div>
          </div>
